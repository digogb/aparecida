...
export const routes: AppRoute[] = [
  { path: '/', element: <DashboardPage />, label: 'Dashboard', icon: 'home', showInSidebar: true },
  ...
  { path: '/movimentacoes', element: <MovementList />, label: 'Movimentações', icon: 'bell', showInSidebar: true },
  { path: '/tarefas', element: <KanbanBoard />, label: 'Tarefas', icon: 'columns', showInSidebar: true },
]
